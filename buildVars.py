...
addon_info = {
	...
	"addon_description" : _("""This add-on improve the use of Windows Magnifier:
- add extra shortcuts for Magnifier's configuration
- vocalize some Magnifier's native shortcuts"""),
	# version
	"addon_version" : "1.0",
	# Author(s)

...
* Añade varios atajos de teclado para conmutar ciertas opciones de la lupa.
...
* Anunciar movimientos de la vista: controla qué se anuncia al mover la
  ...
  Esta opción sólo afecta al modo de pantalla completa.
...
* En documentos y vistas de lista, pasar a la lupa los atajos
  control+alt+flechas: hay tres posibles opciones:
    ...
    * Sólo si no es una tabla: en las tablas y en las listas, las órdenes
      ...
      órdenes control+alt+flechas. Esta opción es la más equilibrada si
      quieres usar control+alt+flechas tanto en el movimiento de la lupa
      como en la navegación por tablas.
...
órdenes adicionales que permiten controlar las opciones de la lupa sin abrir
su página de configuración. Todas las órdenes para controlar las opciones de
la lupa están accesibles a través de la orden de capa de la lupa
NVDA+windows+o:
...
* NVDA+windows+o seguido de v: mueve el cursor del ratón al centro de la
  vista ampliada (orden disponible sólo en la vista de pantalla completa).
...
* Redimensionar la lente con el teclado: shift+alt+flechas izquierda,
  ...
  Windows 2004.
* Mover la vista ampliada: control+alt+flechas (la indicación sólo afecta al
